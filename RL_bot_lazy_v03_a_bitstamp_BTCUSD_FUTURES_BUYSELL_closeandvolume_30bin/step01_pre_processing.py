# we have a file with open/High/Low/Close prices, we only want a open price and Volume
...
OUTPUT_FILE = '../data/bitstamp_btc_usd_only_Timestamp_and_close_price_and_volume_30m.csv'
...
# btc_usdt_df.drop(['Open', 'High', 'Low'], 'columns', inplace=True)
